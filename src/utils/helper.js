...
export const Sidebar_ICONS = [
  {
    iconName: <HomeOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "Home",
    link: "/",
  },
  {
    iconName: <SubscriptionsOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "Subscriptions",
  },
  {
    iconName: <VideoLibraryOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "Library",
  },
  {
    iconName: <RestoreOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "History",
  },
  {
    iconName: <WatchLaterOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "Watch Later",
  },
  {
    iconName: <SlideshowOutlinedIcon sx={{ fontSize: "30px" }} />,
    title: "Your Videos",
  },
];
