...
export default function Header() {
  ...
  return (
    <div className="flex justify-between items-center  px-10 w-full fixed bg-white z-40 ">
      <div className=" flex gap-4 justify-center items-center ">
        <div className="logo max-w-[23px] cursor-pointer">
          <img
      ...
      <div className="search_bar w-1/2 ">
